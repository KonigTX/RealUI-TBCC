...
--luacheck:globals WOW_PROJECT_ID WOW_PROJECT_CLASSIC WOW_PROJECT_MISTS_CLASSIC WOW_PROJECT_BURNING_CRUSADE_CLASSIC WOW_PROJECT_WRATH_CLASSIC
-- TBCC: Include TBC Classic and WotLK Classic in the classic check
local CLASSIC = WOW_PROJECT_ID == WOW_PROJECT_CLASSIC
local TBC = WOW_PROJECT_ID == (WOW_PROJECT_BURNING_CRUSADE_CLASSIC or 5) -- WOW_PROJECT_BURNING_CRUSADE_CLASSIC = 5
local WRATH = WOW_PROJECT_ID == (WOW_PROJECT_WRATH_CLASSIC or 11) -- WOW_PROJECT_WRATH_CLASSIC = 11
local MISTS = WOW_PROJECT_ID == WOW_PROJECT_MISTS_CLASSIC
kui.CLASSIC = CLASSIC or TBC or WRATH or MISTS -- All non-retail versions
kui.TBC = TBC
kui.WRATH = WRATH
kui.CATA = MISTS
