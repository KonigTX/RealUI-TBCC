...
-- TBCC: Helper function to safely call skin functions
...
local function SkinAceConfig()
    ...
    if AceCD.tooltip then
        ...
        if Skin.GameTooltipTemplate and type(Skin.GameTooltipTemplate) == "function" then
    ...
    if AceCD.popup then
        ...
        -- TBCC: Check if skin function exists before calling
        if Skin.DialogBorderDarkTemplate and type(Skin.DialogBorderDarkTemplate) == "function" then
...
local function SkinAceGUI()
    ...
    local containters = {
        ...
        Frame = function(widget)
            ...
            SafeSkin(Skin.UIPanelButtonTemplate,children[1]) -- closebutton
        ...
        ScrollFrame = function(widget)
            -- TBCC: UIPanelScrollBarTemplate may not exist in TBCC's Aurora skin library
            SafeSkin(Skin.UIPanelScrollBarTemplate, widget.scrollbar)
        end,
        ...
        TabGroup = function(widget)
            ...
            function widget:CreateTab(id)
                ...
                -- TBCC: Check if skin function exists before calling
                SafeSkin(Skin.OptionsFrameTabButtonTemplate, tab)
                return tab
            end
        ...
        TreeGroup = function(widget)
            ...
            function widget:CreateButton(...)
                ...
                -- TBCC: OptionsListButtonTemplate may not exist
                SafeSkin(Skin.OptionsListButtonTemplate, button)
                return button
            end
            ...
            -- TBCC: UIPanelScrollBarTemplate may not exist in TBCC's Aurora skin library
            if Skin.UIPanelScrollBarTemplate and type(Skin.UIPanelScrollBarTemplate) == "function" then
        ...
        Window = function(widget)
            ...
            -- TBCC: UIPanelCloseButton may not exist
            SafeSkin(Skin.UIPanelCloseButton, widget.closebutton)
    ...
    widgets = {
        -- AceGUI
            Button = function(widget)
                SafeSkin(Skin.UIPanelButtonTemplate,widget.frame)
            end,
            ...
            ["Dropdown-Pullout"] = function(widget)
                ...
                -- TBCC: OptionsSliderTemplate may not exist
                SafeSkin(Skin.OptionsSliderTemplate, widget.slider)
                if widget.slider and widget.slider.GetThumbTexture then
                    local thumb = widget.slider:GetThumbTexture()
                    if thumb then thumb:SetSize(16, 16) end
                end
            end,
            Dropdown = function(widget)
                -- TBCC: DropdownButton may not exist
                SafeSkin(Skin.DropdownButton, widget.dropdown)
                if widget.dropdown and widget.dropdown.SetBackdropOption then
            ...
            EditBox = function(widget)
                -- TBCC: InputBoxTemplate may not exist
                SafeSkin(Skin.InputBoxTemplate, widget.editbox)
                SafeSkin(Skin.UIPanelButtonTemplate,widget.button)
            end,
            ...
            MultiLineEditBox = function(widget)
                SafeSkin(Skin.UIPanelButtonTemplate,widget.button)
                -- TBCC: UIPanelScrollBarTemplate may not exist
                SafeSkin(Skin.UIPanelScrollBarTemplate, widget.scrollBar)
        ...
        -- Custom
            NumberEditBox = function(widget)
                ...
                SafeSkin(Skin.InputBoxTemplate, widget.editbox)
                SafeSkin(Skin.UIPanelButtonTemplate,widget.button)
                SafeSkin(Skin.UIPanelButtonTemplate,widget.minus)
                SafeSkin(Skin.UIPanelButtonTemplate,widget.plus)
            end,
        ...
        -- WeakAuras
            ...
            WeakAurasDisplayButton = function(widget)
                ...
                -- TBCC: These skin functions may not exist
                SafeSkin(Skin.InputBoxTemplate, widget.renamebox)
                SafeSkin(Skin.ExpandOrCollapse, widget.expand)
            end,
            ...
            WeakAurasLoadedHeaderButton = function(widget)
                widgets.WeakAuras(widget)
                -- TBCC: ExpandOrCollapse may not exist
                SafeSkin(Skin.ExpandOrCollapse, widget.expand)
            end,
