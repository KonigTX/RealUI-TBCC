...
-- TBCC: Check if private.AddOns["Blizzard_WorldMap"] exists and is a function
if private.AddOns["Blizzard_WorldMap"] and type(private.AddOns["Blizzard_WorldMap"]) == "function" then
