...
do --[[ SharedXML\FriendsFrame.lua ]]
    ...
    -- TBCC: Check if Hook.FriendsFrame_UpdateFriendButton exists before hooking
    if not (Hook.FriendsFrame_UpdateFriendButton and type(Hook.FriendsFrame_UpdateFriendButton) == "function") then
        return
    end
