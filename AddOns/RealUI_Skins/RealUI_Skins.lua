...
function private.OnLoad()
    ...
    -- TBCC: AzeriteEmpoweredItemUITemplate is a BFA feature, doesn't exist in TBC
    if Skin.AzeriteEmpoweredItemUITemplate and type(Skin.AzeriteEmpoweredItemUITemplate) == "function" then
    ...
    -- TBCC: Check if skin function exists before hooking
    if Skin.PanelTabButtonTemplate and type(Skin.PanelTabButtonTemplate) == "function" then
    ...
    -- TBCC: Check if Blizzard_BarbershopUI hook exists before calling
    if private.AddOns and private.AddOns["Blizzard_BarbershopUI"] and type(private.AddOns["Blizzard_BarbershopUI"]) == "function" then
    ...
    function private.AddOns.nibRealUI()
        ...
        -- TBCC: Check if NavBarTemplate exists before calling
        if Skin.NavBarTemplate and type(Skin.NavBarTemplate) == "function" and _G.WorldMapFrame and _G.WorldMapFrame.NavBar then
    ...
    function private.AddOns.RealUI_Bugs()
        ...
        -- TBCC: Check if skin functions exist before calling
        if Skin.UIPanelDialogTemplate and type(Skin.UIPanelDialogTemplate) == "function" then
            Skin.UIPanelDialogTemplate(errorFrame)
        end
        if Skin.ScrollFrameTemplate and type(Skin.ScrollFrameTemplate) == "function" then
            Skin.ScrollFrameTemplate(errorFrame.ScrollFrame)
        end
        if Skin.UIPanelButtonTemplate and type(Skin.UIPanelButtonTemplate) == "function" then
            Skin.UIPanelButtonTemplate(errorFrame.Reload)
        end
        if Skin.NavButtonPrevious and type(Skin.NavButtonPrevious) == "function" then
            Skin.NavButtonPrevious(errorFrame.PreviousError)
        end
        if Skin.NavButtonNext and type(Skin.NavButtonNext) == "function" then
