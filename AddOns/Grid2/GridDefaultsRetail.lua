...
-- TBCC: For Classic versions, provide stub implementations instead of returning early
-- This prevents "attempt to call method 'MakeDefaultsCommon' (a nil value)" errors
if Grid2.isClassic then
	local Grid2 = Grid2
	local Location = Grid2.CreateLocation

	-- Provide a basic defaults implementation for Classic
	...
	-- Default class function (empty) - classes can be extended later
	function Grid2:MakeDefaultsClass()
		-- Empty implementation for Classic
		-- Individual class defaults can be added here if needed
	end
