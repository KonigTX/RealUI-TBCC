...
local function Hook_VSI()
    -- TBCC: VehicleSeatIndicator may not exist in TBCC
    if not _G.VehicleSeatIndicator then return end
...
local function Hook_Raven()
    -- TBCC: C_AddOns.IsAddOnLoaded doesn't exist, use IsAddOnLoaded
