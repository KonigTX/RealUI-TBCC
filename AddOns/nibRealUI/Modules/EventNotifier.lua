...
local function toggleCalendar()
    -- TBCC: Use LoadAddOn() instead of C_AddOns.LoadAddOn()
...
function EventNotifier:OnEnable()
    ...
    -- TBCC: VIGNETTE_MINIMAP_UPDATED is a Retail-only event (vignettes = rares on minimap)
    -- This feature is not available in TBCC
