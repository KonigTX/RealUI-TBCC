...
-- TBCC: Check if UIPanelButtonTemplate skin exists before calling
local Skin = _G.Aurora.Skin
if Skin and Skin.UIPanelButtonTemplate and type(Skin.UIPanelButtonTemplate) == "function" then
    Skin.UIPanelButtonTemplate(setsButton)
end
