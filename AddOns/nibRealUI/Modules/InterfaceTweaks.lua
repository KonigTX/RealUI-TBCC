...
--        Auto Holiday Boss        --
----====####$$$$%%%%%$$$$####====----
-- TBCC: LFD (Looking For Dungeon) was added in WotLK, doesn't exist in TBC
-- This feature is disabled for TBCC
do
    AddTweak("autoHoliday", {
        name = "Tweaks_AutoHoliday",
    })
    -- TBCC: LFDParentFrame doesn't exist in TBC Classic
    -- This feature cannot work without the Dungeon Finder system
