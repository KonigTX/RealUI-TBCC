...
local function CreateInstallWindow()
    ...
    if RealUI:IsUsingHighResDisplay() then
        ...
        if _G.Aurora and _G.Aurora.Skin and _G.Aurora.Skin.OptionsBaseCheckButtonTemplate and type(_G.Aurora.Skin.OptionsBaseCheckButtonTemplate) == "function" then
...
local function InstallationStage1()
    ...
    -- Set version info
    -- TBCC: Add nil check for RealUI.verinfo
    if RealUI.verinfo then
        dbg.verinfo = {}
...
local function MiniPatchInstallation(newVer)
    -- TBCC: Add nil checks for version info
    local curVer = RealUI.verinfo or {}
    local oldVer = dbg.verinfo or {}
...
function RealUI:InstallProcedure()
    ...
    -- TBCC: Add nil checks for version info
    local curVer = RealUI.verinfo or {}
    local oldVer = ((dbg.verinfo and dbg.verinfo[1]) and dbg.verinfo) or RealUI.verinfo or {}
