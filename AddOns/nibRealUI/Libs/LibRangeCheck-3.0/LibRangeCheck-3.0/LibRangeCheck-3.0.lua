...
function lib:activate()
  if not self.frame then
    ...
    -- TBCC: LEARNED_SPELL_IN_TAB doesn't exist in TBCC, wrap in pcall
    local success = pcall(frame.RegisterEvent, frame, "LEARNED_SPELL_IN_TAB")
    if not success then
      -- Event doesn't exist in this version, use alternative
