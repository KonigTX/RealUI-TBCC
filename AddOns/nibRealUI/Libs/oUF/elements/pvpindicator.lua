...
local function Update(self, event, unit)
	...
	* unit - the unit for which the update has been triggered (string)
	...
	-- TBCC: C_PvP.GetHonorRewardInfo and UnitHonorLevel don't exist in TBC Classic
	local honorRewardInfo = nil
	if C_PvP and C_PvP.GetHonorRewardInfo and UnitHonorLevel then
...
local function Enable(self)
	...
	if(element) then
		...
		-- TBCC: HONOR_LEVEL_UPDATE doesn't exist in TBC Classic, skip registration entirely
		-- In Retail this event tracks honor level changes for the badge display
...
local function Disable(self)
	...
	if(element) then
		...
		-- TBCC: HONOR_LEVEL_UPDATE doesn't exist, no need to unregister
	end
end
