...
function Infobar:CreateBlocks()
    ...
    do  -- Start
        ...
        local function ToggleUI(this, arg1, arg2, isChecked)
            ...
            if type(_G[arg1]) ~= "function" then return end
            _G[arg1](arg2)
        end
        ...
        LDB:NewDataObject("clock", {
            ...
            OnClick = function(block, ...)
                ...
                if _G.IsAltKeyDown() then
                    ...
                    if IsAddOnLoaded and IsAddOnLoaded("GroupCalendar5") then
    ...
    do -- Progress Watch
        ...
        watchStates["honor"] = {
            ...
            GetStats = function(Honor)
                -- TBCC: UnitHonor/UnitHonorMax don't exist, return 0
                if _G.UnitHonor and _G.UnitHonorMax then
    ...
    do -- Currency
        ...
        local function GetInlineFactionIcon(faction)
            local questAtlas = _G.QUEST_TAG_ATLAS or {}
            local fIcon = {
                ["HORDE"] = questAtlas["HORDE"],
                ["ALLIANCE"] = questAtlas["ALLIANCE"],
                ["NEUTRAL"] = "BattleMaster"
            }
            if not _G.CreateAtlasMarkup or not faction then
                return ""
            end
            local iconName = fIcon[faction:upper()] or "BattleMaster"
            return _G.CreateAtlasMarkup(iconName, 16, 16)
        end
        ...
        local function UpdateTrackedCurrency(block)
            ...
            -- TBCC: C_CurrencyInfo.GetBackpackCurrencyInfo doesn't exist in TBC Classic
            if not _G.C_CurrencyInfo or not _G.C_CurrencyInfo.GetBackpackCurrencyInfo then return end
            local changeIndex
        ...
        LDB:NewDataObject("currency", {
            ...
            OnEnable = function(block)
                ...
                if RealUI.realmInfo.realmNormalized then
                    ...
                    -- TBCC: SetCurrencyBackpack doesn't exist in TBC Classic
                    if _G.C_CurrencyInfo and _G.C_CurrencyInfo.SetCurrencyBackpack then
